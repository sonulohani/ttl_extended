...
namespace impl
{
template <typename R> struct functor_caller_base0
{
...
template <typename F, typename R> struct functor_caller0 : functor_caller_base0<R>
{
    ...
    {
        return ttl::mem::create<allocator>(f_);
    }
};

#define TTL_FUNC_BUILD_FUNCTOR_CALLER(n)                                                                               \
    template <typename R, TTL_TPARAMS(n)> struct functor_caller_base##n                                                \
    {                                                                                                                  \
    ...
    template <typename F = empty_type, typename R = empty_type, TTL_TPARAMS_DEF(n, empty_type)>                        \
    struct functor_caller##n;                                                                                          \
    ...
    {                                                                                                                  \
        ...
        virtual return_type operator()(TTL_FUNC_PARAMS(n, p))                                                          \
        {                                                                                                              \
            return f_(TTL_ENUM_ITEMS(n, p));                                                                           \
        }                                                                                                              \
        virtual base_t *clone() const                                                                                  \
        {                                                                                                              \
            return ttl::mem::create<allocator>(f_);                                                                    \
...
template <typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS)> struct function
{
    ...
    template <typename F> function(F f) : fc_(0)
    {
...
template <typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS)> struct function<R(TTL_ARGS(10)), T11, T12, T13, T14, T15>
{
    TTL_FUNC_BUILD_FUNCTION(10)
};
template <typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS)> struct function<R(TTL_ARGS(11)), T12, T13, T14, T15>
{
    TTL_FUNC_BUILD_FUNCTION(11)
};
template <typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS)> struct function<R(TTL_ARGS(12)), T13, T14, T15>
{
    TTL_FUNC_BUILD_FUNCTION(12)
};
template <typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS)> struct function<R(TTL_ARGS(13)), T14, T15>
{
    TTL_FUNC_BUILD_FUNCTION(13)
};
template <typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS)> struct function<R(TTL_ARGS(14)), T15>
{
    TTL_FUNC_BUILD_FUNCTION(14)
};
template <typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS)> struct function<R(TTL_ARGS(15))>
{
