...
namespace impl
{
template <typename F> struct connection_holder : connection_holder_base
{
...
template <typename F> struct signal_base
{
...
template <typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS)>
struct signal<R(TTL_ARGS(12)), T13, T14, T15> : impl::signal_base<func::function<R(TTL_ARGS(12)), T13, T14, T15>>
{
...
template <typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS)>
struct signal<R(TTL_ARGS(13)), T14, T15> : impl::signal_base<func::function<R(TTL_ARGS(13)), T14, T15>>
{
...
template <typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS)>
struct signal<R(TTL_ARGS(14)), T15> : impl::signal_base<func::function<R(TTL_ARGS(14)), T15>>
{
...
template <typename R, TTL_TPARAMS(TTL_MAX_FUNCTION_PARAMS)>
struct signal<R(TTL_ARGS(15))> : impl::signal_base<func::function<R(TTL_ARGS(15))>>
{
