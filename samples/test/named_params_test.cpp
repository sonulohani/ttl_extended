...
struct widget
{
    ...
    typedef ttl::func::named_params_function<int // the function returns 'int'
                                             (
                                                 //'argument name',  'argument type'
                                                 struct title, const char *, struct style,
                                                 ttl::func::numeric_argument<int, 45> // the default is 45
                                                 )>
        create_functor;
...
void named_params_test()
{
    ...
    w.create(w.create.arg<title>("custom style"), w.create.arg<style>(3));
